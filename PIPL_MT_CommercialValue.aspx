<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PIPL_MT_CommercialValue.aspx.cs" Inherits="REPI_PUR_SOFRA.PIPL_MT_CommercialValue" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">COMMERCIAL VALUE</p>
                        </div>                        
                    </div>
                </div>
            </div>
                                 ...
                                 <Columns>
                                    <asp:TemplateField HeaderText="NAME" HeaderStyle-Width="1050px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("Name") %>' Width="822px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
