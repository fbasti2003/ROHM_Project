<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RFQ_ManualApproved.aspx.cs" Inherits="REPI_PUR_SOFRA.RFQ_ManualApproved" MasterPageFile="~/Sofra.Master" %>
                    ...
                    <div class="card"> 
                        <div class="header" style="height:80px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">
                                RFQ MANUAL APPROVED FOR (<%= rfqNo.ToString() %>)
                            </p>
                            <p style="color:Red; font-size:12px; font-weight:bold;">*** Make sure that you select valid pdf file for pdf attachment. It must be correct RFQ Number and correct pdf file attachment.</p>
                        </div>                        
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1280px;">
                    <div class="card">
                        <div class="body" style="margin-top:-23px; min-height:80px; width:1280px;">
                            PDF FILE
                            <asp:FileUpload ID="fuManualApproved" runat="server" Font-Size="Large" Width="600px" EnableViewState="true" accept=".pdf"  />
                        </div>
                    </div>
                </div>
            </div>
