...
{
    public partial class DRF_MT_TypesOfAbnormality : System.Web.UI.Page
    {
        ...
        private void LoadDefault()
        {
            try
            {
                ...
                list = BLL.DRF_MT_TypesOfAbnormality_GetAll();
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_DRF_TypesOfAbnormality entity = new Entities_DRF_TypesOfAbnormality();
                        entity.RefId = lblId.Text.Trim();
                        entity.IsDisabled = "0";

                        BLL.DRF_MT_TypesOfAbnormality_IsDisabled(entity);
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.DRF_MT_TypesOfAbnormality_Append(entity);
                ...
                if (e.CommandName == "SaveNew_Command")
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            else if (BLL.DRF_MT_TypesOfAbnormality_GetByName(entity.Name).Count > 0)
                            {
                                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "ErrorMessage('" + entity.Name + " is already exist.');", true);
                            }
                            else
                            {
                                BLL.DRF_MT_TypesOfAbnormality_Insert(entity);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Entities_DRF_TypesOfAbnormality> list = new List<Entities_DRF_TypesOfAbnormality>();
                list = BLL.DRF_MT_TypesOfAbnormality_GetByName_Like(txtSearch.Text);
