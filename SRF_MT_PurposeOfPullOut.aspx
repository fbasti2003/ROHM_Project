<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRF_MT_PurposeOfPullOut.aspx.cs" Inherits="REPI_PUR_SOFRA.SRF_MT_PurposeOfPullOut" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">PURPOSE OF PULLOUT</p>
                        </div>                        
                    </div>
                </div>
            </div>
                    ...
                    <div class="tab-content" style="margin-top:10px;">
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="active">
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                 ...
                                 <Columns>
                                    <asp:TemplateField HeaderText="NAME" HeaderStyle-Width="1025px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("Name") %>' />
                                            <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("Name") %>' Width="1025px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewName" runat="server" Width="1025px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>                                                                                                
                                <Columns>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="inactive">
                            ...
                            <asp:GridView ID="gvDisabled" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="NAME" HeaderStyle-Width="820px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("Name") %>' Width="815px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
