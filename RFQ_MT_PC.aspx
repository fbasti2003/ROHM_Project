<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RFQ_MT_PC.aspx.cs" Inherits="REPI_PUR_SOFRA.RFQ_MT_PC" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">PC TABLE</p>
                        </div>                        
                    </div>
                </div>
            </div>
                    ...
                    <div class="tab-content" style="margin-top:10px;">
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="active">
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="DESCRIPTION" HeaderStyle-Width="600px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("Description") %>' />
                                            <asp:TextBox ID="txtDescription" runat="server" Text='<%# Eval("Description") %>' Width="597px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewDescription" runat="server" Width="597px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>                                                                                               
                                <Columns>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="inactive">
                            ...
                            <asp:GridView ID="gvDisabled" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="DESCRIPTION" HeaderStyle-Width="590px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("Description") %>' Width="590px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
