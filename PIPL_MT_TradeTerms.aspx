<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PIPL_MT_TradeTerms.aspx.cs" Inherits="REPI_PUR_SOFRA.PIPL_MT_TradeTerms" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">TRADE TERMS</p>
                        </div>                        
                    </div>
                </div>
            </div>
