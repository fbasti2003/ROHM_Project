<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SE_MT_FiscalYear.aspx.cs" Inherits="REPI_PUR_SOFRA.SE_MT_FiscalYear" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">FISCAL YEAR TABLE</p>
                        </div>                        
                    </div>
                </div>
            </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="active">
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                 ...
                                 <Columns>
                                    <asp:TemplateField HeaderText="FROM" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblFrom" runat="server" Text='<%# Eval("From") %>' />
                                            <asp:TextBox ID="txtFrom" runat="server" Text='<%# Eval("From") %>' Width="150px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewFrom" runat="server" Width="150px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>  
                                <Columns>
                                    <asp:TemplateField HeaderText="TO" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblTo" runat="server" Text='<%# Eval("To") %>' />
                                            <asp:TextBox ID="txtTo" runat="server" Text='<%# Eval("To") %>' Width="150px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewTo" runat="server" Width="150px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                 <Columns>
                                    <asp:TemplateField HeaderText="DESCRIPTION" HeaderStyle-Width="745px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("Description") %>' Width="745px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>                                                                                               
                                <Columns>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="inactive">
                            ...
                            <asp:GridView ID="gvDisabled" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="FROM" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblFrom" runat="server" Text='<%# Eval("From") %>' Width="150px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="TO" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblTo" runat="server" Text='<%# Eval("To") %>' Width="150px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
