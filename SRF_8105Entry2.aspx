<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRF_8105Entry2.aspx.cs" Inherits="REPI_PUR_SOFRA.SRF_8105Entry2" MasterPageFile="~/Sofra.Master" %>
                            ...
                            <div style="margin-top:10px;">
                                <table style="width:1750px; color:Gray; font-size:12px;">
                                  ...
                                  <tr>
                                    ...
                                    <td><asp:TextBox ID="txtSearch" runat="server" Width="200px" Height="28px" Font-Bold="true" Font-Size="14px" class="form-control" onkeydown='searchWithKeyPress(this)' /></td>
                                    <td>
                                        <asp:DropDownList ID="ddCategory" runat="server" Width="260px" Height="28px" class="form-control" />
                                    </td>
                                    <td>
                    ...
                    <div class="card"> 
                        <div class="body" style="margin-top:-23px; min-height:100px; width:1800px;">
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="CATEGORY" HeaderStyle-Width="310px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblCategory" runat="server" Width="310px" Text='<%# Eval("CategoryDescription") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="REQUESTER" HeaderStyle-Width="300px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblRequester" runat="server" Height="15px" Width="300px" Text='<%# Eval("Warehouse_RequesterName") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="SUPPLIER" HeaderStyle-Width="335px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblSupplier" runat="server" Height="15px" Width="335px" Text='<%# Eval("Warehouse_SupplierName") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                            ...
                            <div class="card">
                                <div class="body" style="margin-top:-23px; min-height:20px; width:1060px;">
                                    ...
                                    <table style="width:100%; margin-top:10px; color:Gray;">
                                      <tr>                                         
                                        <p style="color:Red; font-size:20px; font-weight:bold;">!!! ATTENTION PLEASE !!!</p>                        
                                      </tr>
                                      <tr>
                                        <p style="color:Red; font-size:14px;">
                                            After clicking SUBMIT or YES button then nothing happens or it will not redirect to success page then check your entry again maybe one of attachment/one-time attachment, 8105 / 8112 NUMBER or PROCESS DATE is empty!
                                        </p>
                                      </tr>
                                    </table>
                                    <hr />
                                    ...
                                    <table style="width:100%; margin-top:10px; color:Gray;">
                                      ...
                                      <tr>
                                        ...
                                        <p id="Reminder2" runat="server" style="color:Red; font-size:12px;">
                                            This is a one-time attachment just incase you have the same document for all items and you don't have to select the one by one ATTACHMENT (Choose File) field. If you are receiving <br /> different documents for every items then you should add
                                            the attachment by clicking ATTACHMENT (Choose File) field.
                                        </p>
                                      </tr>
                                    </table>
                                    <hr />
                                    ...
                                    <table style="width:100%; margin-top:10px; color:Gray; text-align:left;">
                                        ...
                                        <tr>
                                            <div class="WordWrap">
                                            <asp:GridView ID="gvActualDelivery" runat="server" OnRowCommand="gvActualDelivery_RowCommand" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="ITEM NAME" ItemStyle-Width="155px" ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblItemName" runat="server" Width="155px" Text='<%# Eval("Warehouse_ItemName") %>' ></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="DELIVERED DATE" ItemStyle-Width="110px" ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDeliveredDate" runat="server" Width="110px" Text='<%# Eval("Warehouse_DeliveredDate") %>' ></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="8105 / 8112 NUMBER" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtLOA8105Number" runat="server" Width="100px" Text='<%# Eval("Warehouse_8105") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="8105 / 8112 PROCESS DATE" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txt8105ProcessDate" runat="server" Width="100px" Text='<%# Eval("Warehouse_LOA8105ProcessDate") %>' placeholder="mm/dd/yyyy" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="ATTACHMENT" ItemStyle-Width="140px" ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:FileUpload ID="fuAttachment" runat="server" Width="140px" EnableViewState="true" accept=".pdf" />
                                                            <asp:LinkButton ID="lbAttachment" runat="server" Visible="false" Text='<%# Eval("Warehouse_Attachment") %>' CommandName="lbAttachment_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="ATTACHMENT FROM WAREHOUSE" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbAttachmentFromWarehouse" runat="server" Width="120px" Text='<%# Eval("Warehouse_AttachmentWarehouse") %>' CommandName="lbAttachmentFromWarehouse_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="REMOVE" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnRemove" runat="server" Width="100px" Text="REMOVE" Visible="false" CssClass="btn btn-block bg-indigo waves-effect" CommandName="btnRemove_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
