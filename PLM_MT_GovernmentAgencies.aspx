<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PLM_MT_GovernmentAgencies.aspx.cs" Inherits="REPI_PUR_SOFRA.PLM_MT_GovernmentAgencies" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">PERMIT CERTIFICATE AGENCY TABLE</p>
                        </div>                        
                    </div>
                </div>
            </div>
