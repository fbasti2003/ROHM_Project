...
{
    public partial class PIPL_MT_Purpose : System.Web.UI.Page
    {
        ...
        private void LoadDefault()
        {
            try
            {
                ...
                list = BLL.PIPL_MT_Purpose_GetAll();
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_PIPL_Purpose entity = new Entities_PIPL_Purpose();
                        entity.RefId = lblId.Text.Trim();
                        entity.IsDisabled = "0";

                        BLL.PIPL_MT_Purpose_IsDisabled(entity);
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.PIPL_MT_Purpose_Append(entity);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Entities_PIPL_Purpose> list = new List<Entities_PIPL_Purpose>();
                list = BLL.PIPL_MT_Purpose_GetByName_Like(txtSearch.Text);
