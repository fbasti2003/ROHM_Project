<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SE_MT_EvaluationCriteriaForMaterial.aspx.cs" Inherits="REPI_PUR_SOFRA.SE_MT_EvaluationCriteriaForMaterial" MasterPageFile="~/Sofra.Master"%>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">SUPPLIER'S EVALUATION CRITERIA (FOR MATERIAL)</p>
                        </div>                        
                    </div>
                </div>
            </div>
                    ...
                    <div class="tab-content" style="margin-top:10px;">
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="active">
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="ID" HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="TYPE" HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            ...
                                            <asp:DropDownList ID="ddLevel" runat="server" Width="40px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" >
                                                <asp:ListItem Text="Quality Results" Value="Quality Results" />
                                                <asp:ListItem Text="Audit Results" Value="Audit Results" />
                                                <asp:ListItem Text="Quality Assurance System" Value="Quality Assurance System" />
                                            </asp:DropDownList>
                                        </ItemTemplate>  
                                        <FooterTemplate>
                                            <asp:DropDownList ID="ddLevelNew" runat="server" Width="40px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" >
                                                <asp:ListItem Text="Quality Results" Value="Quality Results" />
                                                <asp:ListItem Text="Audit Results" Value="Audit Results" />
                                                <asp:ListItem Text="Quality Assurance System" Value="Quality Assurance System" />
                                            </asp:DropDownList>
                                 ...
                                 <Columns>
                                    <asp:TemplateField HeaderText="ITEM" HeaderStyle-Width="170px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblItem" runat="server" Text='<%# Eval("ItemName") %>' />
                                            <asp:DropDownList ID="ddItem" runat="server" Width="170px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate>  
                                        <FooterTemplate>
                                            <asp:DropDownList ID="ddItemNew" runat="server" Width="170px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>                                  
                                    </asp:TemplateField>
                                </Columns> 
                                <Columns>
                                    <asp:TemplateField HeaderText="EVALUATION CRITERIA" HeaderStyle-Width="650px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtEvaluationCriteria" runat="server" Text='<%# Eval("Criteria") %>' Width="650px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewEvaluationCriteria" runat="server" Width="650px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="POINTS" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtPoints" runat="server" Text='<%# Eval("Points") %>' Width="100px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewPoints" runat="server" Width="100px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="WEIGHT" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtWeight" runat="server" Text='<%# Eval("Weight") %>' Width="100px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewWeight" runat="server" Width="100px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <%--<Columns>
                                    <asp:TemplateField HeaderText="SCORE" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtScore" runat="server" Text='<%# Eval("Score") %>' Width="100px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewScore" runat="server" Width="100px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>--%>
                                <Columns>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="inactive">
                            ...
                            <asp:GridView ID="gvDisabled" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="ITEM" HeaderStyle-Width="210px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblItem" runat="server" Text='<%# Eval("ItemName") %>' Width="210px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="EVALUATION CRITERIA" HeaderStyle-Width="550px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblEvaluationCriteria" runat="server" Text='<%# Eval("Criteria") %>' Width="550px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="POINTS" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblPoints" runat="server" Text='<%# Eval("Points") %>' Width="100px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="WEIGHT" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblWeight" runat="server" Text='<%# Eval("Weight") %>' Width="100px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="SCORE" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblScore" runat="server" Text='<%# Eval("Score") %>' Width="100px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
