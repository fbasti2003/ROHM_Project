...
{
    public partial class PIPL_MT_TradeTerms : System.Web.UI.Page
    {
        ...
        private void LoadDefault()
        {
            try
            {
                ...
                list = BLL.PIPL_MT_TradeTerms_GetAll();
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_PIPL_TradeTerms entity = new Entities_PIPL_TradeTerms();
                        entity.RefId = lblId.Text.Trim();
                        entity.IsDisabled = "0";

                        BLL.PIPL_MT_TradeTerms_IsDisabled(entity);
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.PIPL_MT_TradeTerms_Append(entity);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Entities_PIPL_TradeTerms> list = new List<Entities_PIPL_TradeTerms>();
                list = BLL.PIPL_MT_TradeTerms_GetByName_Like(txtSearch.Text);
