<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="REPORTING_RFQ.aspx.cs" Inherits="REPI_PUR_SOFRA.REPORTING_RFQ" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1280px;">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">RFQ APPROVAL/DISAPPROVAL COUNTS</p>
                        </div>                        
                    </div>
                </div>
            </div>
                    ...
                    <div class="card"> 
                        <div class="body" style="margin-top:-23px; min-height:200px; width:1280px;">
                            ...
                            <asp:GridView ID="gvDataDetails" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                                                     ...
                                                                     OnRowDataBound="gvDataDivision_OnRowDataBound" EmptyDataText="No Record Found!">
                                <Columns>
                                    <asp:TemplateField HeaderText="RFQ NUMBER" HeaderStyle-Width="130px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblRFQNo" runat="server" Height="15px" Width="130px" Text='<%# Eval("RdRfqNo") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="DESCRIPTION" HeaderStyle-Width="210px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblDescription" runat="server" Height="15px" Width="210px" Text='<%# Eval("RdDescription") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="MAKER" HeaderStyle-Width="130px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblMaker" runat="server" Height="15px" Width="130px" Text='<%# Eval("RdMaker") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="CATEGORY" HeaderStyle-Width="130px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblCategory" runat="server" Height="15px" Width="130px" Text='<%# Eval("RhCategory") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
