<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PLM_PermitHistory.aspx.cs" Inherits="REPI_PUR_SOFRA.PLM_PermitHistory" MasterPageFile="~/Sofra.Master" %>
                            ...
                            <div style="margin-top:10px;">
                                <table style="width:950px; color:Gray; font-size:12px;">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="btnAddNew" runat="server" Text="ADD NEW" Visible="false" Height="28px" CssClass="btn bg-blue waves-effect" OnClick="btnAddNew_Click" />
                                    </td>                      
                                  </tr>
                                </table>
                            </div>
                                                ...
                                                <td colspan="100%" style="background-color:White;">
                                                    <div id="divDetails" runat="server" style="margin-left:7px; margin-bottom:5px; display:none;">
                                                        ...
                                                        <table style="width:980px; color:Gray;">
                                                          ...
                                                          <tr>
                                                            <td colspan="2">
                                                                <asp:LinkButton ID="lbEditRecord" runat="server" Text="EDIT RECORD" Visible="false" ForeColor="Blue" CommandName="EditRecord_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                                ...
                                                                <asp:LinkButton ID="lbRenew" runat="server" Text="RENEW" Visible="false" ForeColor="Red" CommandName="lbRenew_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                            </td>
                                                          </tr>
                                                        </table>
