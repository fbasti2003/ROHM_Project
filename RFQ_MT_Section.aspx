<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RFQ_MT_Section.aspx.cs" Inherits="REPI_PUR_SOFRA.RFQ_MT_Section" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">SECTION TABLE</p>
                        </div>                        
                    </div>
                </div>
            </div>
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="DESCRIPTION" HeaderStyle-Width="585px" ItemStyle-HorizontalAlign="Left" >
                                        ...
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewDescription" runat="server" Width="585px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>                                                                                               
                                <Columns>
