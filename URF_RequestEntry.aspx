<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="URF_RequestEntry.aspx.cs" Inherits="REPI_PUR_SOFRA.URF_RequestEntry" MasterPageFile="~/Sofra.Master" %>
                            ...
                            <div class="body" style="margin-top:-23px; width:1280px;">
                                ...
                                <asp:GridView ID="gvData" runat="server" ShowFooter="True"
                                        ...
                                        <asp:TemplateField HeaderText="PO.NO.">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtPONO" runat="server" Width="110px" Text='<%# Eval("RdPONO") %>' data-toggle="tooltip" data-placement="top" title='<%# Eval("RdPONO") %>'></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="PR.NO.">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtPRNO" runat="server" Text='<%# Eval("RdPRNO") %>' Width="110px" data-toggle="tooltip" data-placement="top" title='<%# Eval("RdPRNO") %>' ></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="ITEM NAME">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtItemName" runat="server" Text='<%# Eval("RdItemName") %>' Width="200px" data-toggle="tooltip" data-placement="top" title='<%# Eval("RdItemName") %>' ></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="SPECIFICATION">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtSpecification" runat="server" Text='<%# Eval("RdSpecs") %>' Width="200px" data-toggle="tooltip" data-placement="top" title='<%# Eval("RdSpecs") %>' ></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="PO DATE">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtDeliveryConfirmationDate" runat="server" Text='<%# Eval("RdDeliveryConfirmationDate") %>' Width="100px" ></asp:TextBox>
                                            </ItemTemplate>                    
                                        </asp:TemplateField>
