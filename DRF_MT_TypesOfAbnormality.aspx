<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DRF_MT_TypesOfAbnormality.aspx.cs" Inherits="REPI_PUR_SOFRA.DRF_MT_TypesOfAbnormality" MasterPageFile="~/Sofra.Master"%>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">TYPES OF ABNORMALITY</p>
                        </div>                        
                    </div>
                </div>
            </div>
