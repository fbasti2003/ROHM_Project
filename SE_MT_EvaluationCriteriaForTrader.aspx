<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SE_MT_EvaluationCriteriaForTrader.aspx.cs" Inherits="REPI_PUR_SOFRA.SE_MT_EvaluationCriteriaForTrader" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">SUPPLIER'S EVALUATION CRITERIA (FOR TRADER)</p>
                        </div>                        
                    </div>
                </div>
            </div>
                                 ...
                                 <Columns>
                                    <asp:TemplateField HeaderText="ITEM" HeaderStyle-Width="210px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            ...
                                            <asp:DropDownList ID="ddItem" runat="server" Width="210px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate>  
                                        <FooterTemplate>
                                            <asp:DropDownList ID="ddItemNew" runat="server" Width="210px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>                                  
                                    </asp:TemplateField>
                                </Columns> 
                                <Columns>
                                    <asp:TemplateField HeaderText="EVALUATION CRITERIA" HeaderStyle-Width="550px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtEvaluationCriteria" runat="server" Text='<%# Eval("Criteria") %>' Width="550px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewEvaluationCriteria" runat="server" Width="550px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="POINTS" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblPoints" runat="server" Text='<%# Eval("Points") %>' />
                                            <asp:TextBox ID="txtPoints" runat="server" Text='<%# Eval("Points") %>' Width="150px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewPoints" runat="server" Width="150px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="JUDGEMENT" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblJudgement" runat="server" Text='<%# Eval("Judgement") %>' />
                                            <asp:TextBox ID="txtJudgement" runat="server" Text='<%# Eval("Judgement") %>' Width="150px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewJudgement" runat="server" Width="150px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="inactive">
                            ...
                            <asp:GridView ID="gvDisabled" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="POINTS" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblPoints" runat="server" Text='<%# Eval("Points") %>' Width="150px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="JUDGEMENT" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblJudgement" runat="server" Text='<%# Eval("Judgement") %>' Width="150px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
