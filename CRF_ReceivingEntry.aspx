<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRF_ReceivingEntry.aspx.cs" Inherits="REPI_PUR_SOFRA.CRF_ReceivingEntry" MasterPageFile="~/Sofra.Master" %>
...
<asp:ScriptManager EnablePartialRendering="true" ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <ContentTemplate>
        ...
        <div class="container-fluid" style="margin-left:-20px; width:1480px;">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1480px;">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">CRF RECEIVING ENTRY</p>
                        </div>                        
                    </div>
                </div>
            </div>  
                    ...
                    <div class="card"> 
                        <div class="body" style="margin-top:-23px; height:140px; width:1480px;">
                            ...
                            <div style="margin-top:10px;">
                                <table id="Table1" runat="server" style="width:1000px; color:Gray; font-size:12px;">
                                  <tr>
                                    <th>FROM</th>
                                    <th>TO</th>
                                    <th>STATUS</th> 
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1480px;">
                    <div class="card"> 
                        <div class="body" style="margin-top:-23px; min-height:100px; width:1480px;">
                            
                            <div id="divLoader" runat="server" style="display:none; width:1480px;">
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="CTRLNo" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="lbCTRLNo" runat="server" Height="15px" Width="130px" Text='<%# Eval("CTRLNo") %>' CommandName="lbCTRLNo_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Font-Bold="true" />   
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="CATEGORY" HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Left" > 
                                        <ItemTemplate>
                                            <asp:Label ID="lblCategory" runat="server" Text='<%# Eval("Category") %>' Height="15px" Width="200px" Font-Size="11px" />                                              
                                        </ItemTemplate>                                
                                    </asp:TemplateField>
                                </Columns>
                                 <Columns>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SUPPLIER" HeaderStyle-Width="230px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblSupplier2" runat="server" Height="15px" Width="230px" Text='<%# Eval("Supplier") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="REQUESTER" HeaderStyle-Width="220px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblRequester2" runat="server" Height="15px" Width="220px" Text='<%# Eval("Requester") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="STATUS" HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Left" > 
                                        <ItemTemplate>
                                            <asp:Label ID="lblStatAll" runat="server" Text='<%# Eval("StatAll") %>' Height="15px" Width="200px" Font-Size="11px" ForeColor="White" data-toggle="tooltip" data-placement="top" title='<%# Eval("StatRemarks") %>' />
                                            <asp:Label ID="lblStatColor" runat="server" Text='<%# Eval("CssColorCode") %>' Visible="false" />                                              
                                        </ItemTemplate>                                
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="ACTION" HeaderStyle-Width="95px" ItemStyle-HorizontalAlign="Center" > 
                                        <ItemTemplate>
                                            <table width="100%">
                                                <tr>
                                                    <td align="center" style="margin-left:1px;">
                                                        <asp:ImageButton ID="ibApproved" runat="server" ToolTip="APPROVED TO SEND BUTTON" ImageUrl="~/images/A1.png" Width="20px" Height="20px" CommandName="A_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"  />  
                                                    </td>
                                                    <td align="center" style="margin-left:1px;">
                                                        <asp:ImageButton ID="ibClosed" runat="server" ToolTip="CLOSED BUTTON" ImageUrl="~/images/Close3.png" Width="18px" Height="18px" CommandName="Closed_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"  />  
                                                    </td>  
                                                    <td align="center" style="margin-left:1px;">
                                                    ...
                                                    <td align="center">
                                                        <asp:ImageButton ID="ibManualResponse" runat="server" ToolTip="MANUAL RESPONSE BUTTON" ImageUrl="~/images/ManualResponse.png" Width="20px" Height="20px" CommandName="ibManualResponse_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"  />  
                                                    </td>                                                 
                                                </tr>
                                            </table>                                                                                                                                    
                                        </ItemTemplate>                                
                                                                            ...
                                                                            <asp:Label ID="lblCTRLNoLabel" runat="server" Text='<%# Eval("RdCtrlNo") %>' Visible="false" /> 
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:Label ID="lblTypeDrawingLabel" runat="server" Text="TYPE / DRAWING NO.: " ForeColor="Black" Font-Bold="true" Font-Size="11px" Height="14px" />&nbsp;<asp:TextBox ID="txtSpecificationHead" runat="server" ReadOnly="true" Text='<%# Eval("RdSpecs") %>' Width="489px" Height="18px" Font-Size="11px" />                                                                                        
                                                                                    </td>
                                                                                </tr> 
                                                                                <tr>
                                                                                    <td>
