<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PLM_MT_Supplier.aspx.cs" Inherits="REPI_PUR_SOFRA.PLM_MT_Supplier" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">SUPPLIER / BROKER / BUYER TABLE</p>
                        </div>                        
                    </div>
                </div>
            </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="active">
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                 ...
                                 <Columns>
                                    <asp:TemplateField HeaderText="CODE" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblCode" runat="server" Text='<%# Eval("SupplierCode") %>' />
                                            <asp:TextBox ID="txtCode" runat="server" Text='<%# Eval("SupplierCode") %>' Width="147px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewCode" runat="server" Width="147px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>  
                                <Columns>
                                    <asp:TemplateField HeaderText="EMAIL" HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblEmailAddress" runat="server" Text='<%# Eval("SupplierEmailAddress") %>' />
                                            <asp:TextBox ID="txtEmaiilAddress" runat="server" Text='<%# Eval("SupplierEmailAddress") %>' Width="197px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewEmailAddress" runat="server" Width="197px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>   
                                <Columns>
                                    <asp:TemplateField HeaderText="NAME" HeaderStyle-Width="290px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("SupplierName") %>' />
                                            <asp:TextBox ID="txtDescription" runat="server" Text='<%# Eval("SupplierName") %>' Width="290px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewDescription" runat="server" Width="290px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>  
                                <Columns>
                                    <asp:TemplateField HeaderText="NOTIFICATION TYPE" HeaderStyle-Width="430px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkTakeAction" runat="server" Text="TAKE ACTION" Checked='<%# Convert.ToBoolean(Eval("TakeAction")) %>' Height="16px" Font-Size="11px" />&nbsp;&nbsp;
                                            <asp:CheckBox ID="chkExpired" runat="server" Text="EXPIRED" Checked='<%# Convert.ToBoolean(Eval("Expired")) %>' Height="16px" Font-Size="11px" />&nbsp;&nbsp;
                                            <asp:CheckBox ID="chkRenewed" runat="server" Text="NEW / RENEWED" Checked='<%# Convert.ToBoolean(Eval("Renewed")) %>' Height="16px" Font-Size="11px" />
                                        </ItemTemplate> 
                                        <FooterTemplate>
                                            <asp:CheckBox ID="chkNewTakeAction" runat="server" Text="TAKE ACTION" Height="16px" Font-Size="11px" />&nbsp;&nbsp;
                                            <asp:CheckBox ID="chkNewExpired" runat="server" Text="EXPIRED" Height="16px" Font-Size="11px" />&nbsp;&nbsp;
                                            <asp:CheckBox ID="chkNewRenewed" runat="server" Text="NEW / RENEWED" Height="16px" Font-Size="11px" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                </Columns>                                                                                          
                                <Columns>
                            ...
                            <asp:GridView ID="gvDisabled" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="CODE" HeaderStyle-Width="220px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblCode" runat="server" Text='<%# Eval("SupplierCode") %>' Width="220px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="EMAIL" HeaderStyle-Width="315px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblEmailAddress" runat="server" Text='<%# Eval("SupplierEmailAddress") %>' Width="315px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="NAME" HeaderStyle-Width="490px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("SupplierName") %>' Width="490px" />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
