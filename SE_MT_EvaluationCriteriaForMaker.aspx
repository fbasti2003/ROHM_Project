<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SE_MT_EvaluationCriteriaForMaker.aspx.cs" Inherits="REPI_PUR_SOFRA.SE_MT_EvaluationCriteriaForMaker" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">SUPPLIER'S EVALUATION CRITERIA (FOR MAKER)</p>
                        </div>                        
                    </div>
                </div>
            </div>
