...
{
    public partial class SE_MT_EvaluationCriteriaForMaker : System.Web.UI.Page
    {
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_SE_EvaluationCriteria_Maker entity = new Entities_SE_EvaluationCriteria_Maker();
                        entity.RefId = lblId.Text.Trim();
                        entity.Isdisabled = "0";
                        entity.DisabledBy = Session["UserFullName"].ToString() + " - " + DateTime.Now.ToLongDateString();

                        BLL.SE_MT_EvaluationCriteria_Maker_IsDisabled(entity);
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.SE_MT_EvaluationCriteria_Maker_Append(entity);
                ...
                if (e.CommandName == "SaveNew_Command")
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.SE_MT_EvaluationCriteria_Maker_Insert(entity);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Entities_SE_EvaluationCriteria_Maker> list = new List<Entities_SE_EvaluationCriteria_Maker>();
                list = BLL.SE_MT_EvaluationCriteria_Maker_GetAll().Where(itm => itm.Criteria.Contains(txtSearch.Text)).ToList();
