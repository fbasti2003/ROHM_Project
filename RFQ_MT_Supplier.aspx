<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RFQ_MT_Supplier.aspx.cs" Inherits="REPI_PUR_SOFRA.RFQ_MT_Supplier" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">SUPPLIER TABLE</p>
                        </div>                        
                    </div>
                </div>
            </div>
            <div class="body">
                <div class="table-responsive" style="margin-top:0px;">
                    ...
                    <div style="float:right; margin-top:-29px;">
                        ...
                        <asp:Button ID="btnDownloadReport" runat="server" Text="DOWNLOAD EXCEL REPORT" CssClass="btn bg-light-green waves-effect" Height="25px" OnClick="btnDownloadReport_Click" />
                    </div>
                    ...
                    <div class="tab-content" style="margin-top:10px;">
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="active">
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="ADDRESS" HeaderStyle-Width="392px" ItemStyle-HorizontalAlign="Left" > 
                                        <ItemTemplate>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="EMAIL" HeaderStyle-Width="110px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="CATEGORY" HeaderStyle-Width="210px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddCategory" runat="server" Width="208px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </ItemTemplate>                                    
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="inactive">
                            ...
                            <asp:GridView ID="gvDisabled" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="EMAIL" HeaderStyle-Width="392px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblEmail" runat="server" Text='<%# Eval("EmailAddress") %>' />                                            
                                        </ItemTemplate>                                                             
                                    </asp:TemplateField>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="CATEGORY" HeaderStyle-Width="210px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddCategoryDisabled" runat="server" Width="208px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />                                           
                                        </ItemTemplate>                                                                        
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
