...
{
    public partial class CRF_MT_Reason : System.Web.UI.Page
    {
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.CRF_MT_Reason_Append(entity);
