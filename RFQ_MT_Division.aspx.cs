...
{
    public partial class RFQ_MT_Division : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (COMMON.isUserAllowed(Session["LcRefId"].ToString(), ConfigurationManager.AppSettings["DivisionAccess"].ToString().Trim()))
                {
                    LoadDefault();
                }
                else
        ...
        private void LoadDefault()
        {
            try
            {
                ...
                list = BLL.RFQ_MT_Division_GetAll();
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_RFQ_Division entity = new Entities_RFQ_Division();
                        entity.RefId = lblId.Text.Trim();
                        entity.IsDisabled = "0";
                        entity.DisabledBy = string.Empty;

                        BLL.RFQ_MT_Division_IsDisabled(entity);
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.RFQ_MT_Division_Append(entity);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Entities_RFQ_Division> list = new List<Entities_RFQ_Division>();
                list = BLL.RFQ_MT_Division_GetByDescription_Like(txtSearch.Text);
        ...
        private void LoadExportData()
        {
            ...
            {
                List<Entities_RFQ_Division> list = new List<Entities_RFQ_Division>();
                list = BLL.RFQ_MT_Division_GetAll_Export();
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            "attachment;filename=DivisionTable.xls");
            Response.Charset = "";
