...
{
    public partial class PLM_MT_GovernmentAgencies : System.Web.UI.Page
    {
        ...
        private void LoadDefault()
        {
            try
            {
                ...
                list = BLL.PLM_MT_GovernmentAgencies_GetAll();
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_PLM_GovernmentAgencies entity = new Entities_PLM_GovernmentAgencies();
                        entity.RefId = lblId.Text.Trim();
                        entity.IsDisabled = "0";

                        BLL.PLM_MT_GovernmentAgencies_IsDisabled(entity);
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.PLM_MT_GovernmentAgencies_Append(entity);
                ...
                if (e.CommandName == "SaveNew_Command")
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            else if (BLL.PLM_MT_GovernmentAgencies_GetByName(entity.Name).Count > 0)
                            {
                                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "ErrorMessage('" + entity.Name + " is already exist.');", true);
                            }
                            else
                            {
                                BLL.PLM_MT_GovernmentAgencies_Insert(entity);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Entities_PLM_GovernmentAgencies> list = new List<Entities_PLM_GovernmentAgencies>();
                list = BLL.PLM_MT_GovernmentAgencies_GetByName_Like(txtSearch.Text);
