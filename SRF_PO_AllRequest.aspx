<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRF_PO_AllRequest.aspx.cs" Inherits="REPI_PUR_SOFRA.SRF_PO_AllRequest" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1280px;">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">SRF PULLOUT ALL REQUEST FORM</p>
                        </div>                        
                    </div>
                </div>
            </div>
                    ...
                    <div class="card"> 
                        <div class="body" style="margin-top:-23px; height:100px; width:900px;">
                            ...
                            <div style="margin-top:10px;">
                                <table style="width:750px; color:Gray; font-size:12px;">
                                  <tr>
                                    <th>FROM</th>
                                    <th>TO</th> 
