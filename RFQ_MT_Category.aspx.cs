...
{
    public partial class RFQ_MT_Category : System.Web.UI.Page
    {
        ...
        private void LoadDefault()
        {
            try
            {
                ...
                list = BLL.RFQ_MT_Category_GetAll();
                ...
                if (list.Count > 0)
                {
                    ...
                    TextBox txtNewAging = (TextBox)gvData.FooterRow.FindControl("txtNewAging");

                    lbSaveNew.Style.Add("display", "none");
                    txtNewCode.Enabled = false;
                    txtNewDescription.Enabled = false;
                    txtNewAging.Enabled = false;
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_RFQ_Category entity = new Entities_RFQ_Category();
                        entity.RefId = lblId.Text.Trim();
                        entity.IsDisabled = "0";

                        BLL.RFQ_MT_Category_IsDisabled(entity);
        ...
        protected void gvData_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                TextBox txtAging = row.FindControl("txtAging") as TextBox;
                ...
                Label lblAging = row.FindControl("lblAging") as Label;
                ...
                TextBox txtNewAging = gvData.FooterRow.FindControl("txtNewAging") as TextBox;
                ...
                if (e.CommandName == "StartEditing_Command")
                {
                    if (lbEdit.Text == "CANCEL")
                    {
                        ...
                        lblAging.Style.Add("display", "block");
                    ...
                    else
                    {
                        ...
                        txtAging.Style.Add("display", "block");
                        lblAging.Style.Add("display", "none");
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        entity.Aging = txtAging.Text.Replace("'", "''").ToUpper();
                        ...
                        try
                        {
                            ...
                            {
                                BLL.RFQ_MT_Category_Append(entity);

                                lblCode.Text = txtCode.Text;
                                txtCode.Style.Add("display", "none");
                                lblDescription.Text = txtDescription.Text;
                                txtDescription.Style.Add("display", "none");
                                lblAging.Text = txtDescription.Text;
                                txtAging.Style.Add("display", "none");
                ...
                if (e.CommandName == "SaveNew_Command")
                {
                    ...
                    try
                    {
                        ...
                        entity.Aging = txtNewAging.Text.Replace("'", "''").ToUpper();
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Entities_RFQ_Category> list = new List<Entities_RFQ_Category>();
                list = BLL.RFQ_MT_Category_GetByDescription_Like(txtSearch.Text);
