...
{
    public partial class URF_MT_Reason : System.Web.UI.Page
    {
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_URF_Reason entity = new Entities_URF_Reason();
                        entity.RefId = lblId.Text.Trim();
                        entity.IsDisabled = "0";

                        BLL.URF_MT_Reason_IsDisabled(entity);
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.URF_MT_Reason_Append(entity);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Entities_URF_Reason> list = new List<Entities_URF_Reason>();
                list = BLL.URF_MT_Reason_GetByName_Like(txtSearch.Text);
