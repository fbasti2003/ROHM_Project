<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="REPORTING_CRF.aspx.cs" Inherits="REPI_PUR_SOFRA.REPORTING_CRF" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1280px;">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">CRF APPROVAL/DISAPPROVAL COUNTS</p>
                        </div>                        
                    </div>
                </div>
            </div>
                    ...
                    <div class="card"> 
                        <div class="body" style="margin-top:-23px; min-height:200px; width:1280px;">
                            ...
                            <asp:GridView ID="gvDataDetails" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="DESCRIPTION" HeaderStyle-Width="130px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblDescription" runat="server" Height="15px" Width="130px" Text='<%# Eval("Description") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
