...
{
    public partial class PIPL_MT_PickupLocation : System.Web.UI.Page
    {
        ...
        private void LoadDefault()
        {
            try
            {
                ...
                list = BLL.PIPL_MT_PickupLocation_GetAll();
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_PIPL_PickupLocation entity = new Entities_PIPL_PickupLocation();
                        entity.RefId = lblId.Text.Trim();
                        entity.IsDisabled = "0";

                        BLL.PIPL_MT_PickupLocation_IsDisabled(entity);
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.PIPL_MT_PickupLocation_Append(entity);
                ...
                if (e.CommandName == "SaveNew_Command")
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            else if (BLL.PIPL_MT_PickupLocation_GetByName(entity.Name).Count > 0)
                            {
                                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "ErrorMessage('" + entity.Name + " is already exist.');", true);
                            }
                            else
                            {
                                BLL.PIPL_MT_PickupLocation_Insert(entity);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Entities_PIPL_PickupLocation> list = new List<Entities_PIPL_PickupLocation>();
                list = BLL.PIPL_MT_PickupLocation_GetByName_Like(txtSearch.Text);
