...
{
    public partial class SRF_MT_Others : System.Web.UI.Page
    {
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_SRF_PO_Others entity = new Entities_SRF_PO_Others();
                        entity.RefId = lblId.Text.Trim();
                        entity.IsDisabled = "0";

                        BLL.SRF_MT_PullOutOthers_IsDisabled(entity);
        ...
        protected void gvData_OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    Label lblSRFItemName = (Label)e.Row.FindControl("lblSRFItemName");
                    TextBox txtSRFItemName = (TextBox)e.Row.FindControl("txtSRFItemName");

                    LinkButton lbSave = (LinkButton)e.Row.FindControl("lbSave");

                    txtName.Style.Add("display", "none");
                    txtSRFItemName.Style.Add("display", "none");
        ...
        protected void gvData_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                TextBox txtSRFItemName = row.FindControl("txtSRFItemName") as TextBox;
                Label lblId = row.FindControl("lblId") as Label;
                Label lblName = row.FindControl("lblName") as Label;
                Label lblSRFItemName = row.FindControl("lblSRFItemName") as Label;
                ...
                TextBox txtNewSRFItemName = gvData.FooterRow.FindControl("txtNewSRFItemName") as TextBox;
                ...
                if (e.CommandName == "StartEditing_Command")
                {
                    if (lbEdit.Text == "CANCEL")
                    {
                        ...
                        lblSRFItemName.Style.Add("display", "block");
                    ...
                    else
                    {
                        ...
                        lblSRFItemName.Style.Add("display", "none");
                        txtSRFItemName.Style.Add("display", "block");
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        Entities_SRF_PO_Others entity = new Entities_SRF_PO_Others();
                        entity.RefId = lblId.Text.Trim();
                        entity.Specification = txtName.Text.Replace("'", "''").ToUpper();
                        entity.SrfItemName = txtSRFItemName.Text.Replace("'", "''").ToUpper();
                        ...
                        try
                        {
                            ...
                            {
                                BLL.SRF_MT_PullOutOthers_Append(entity);

                                lblName.Text = txtName.Text;
                                txtName.Style.Add("display", "none");

                                lblSRFItemName.Text = txtSRFItemName.Text;
                                txtSRFItemName.Style.Add("display", "none");
                ...
                if (e.CommandName == "AddNew_Command")
                {
                    if (lbAddNew.Text == "ADD NEW")
                    {
                        ...
                        txtNewSRFItemName.Enabled = true;
                    ...
                    {
                        txtNewName.Enabled = false;
                        txtNewSRFItemName.Enabled = false;
                ...
                if (e.CommandName == "SaveNew_Command")
                {
                    ...
                    {
                        Entities_SRF_PO_Others entity = new Entities_SRF_PO_Others();
                        entity.Specification = txtNewName.Text.Replace("'", "''").ToUpper();
                        entity.SrfItemName = txtNewSRFItemName.Text.Replace("'", "''").ToUpper();
                        ...
                        try
                        {
                            ...
                            {
                                BLL.SRF_MT_PullOutOthers_Insert(entity);
