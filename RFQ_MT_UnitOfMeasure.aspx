<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RFQ_MT_UnitOfMeasure.aspx.cs" Inherits="REPI_PUR_SOFRA.RFQ_MT_UnitOfMeasure" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">UNIT OF MEASURE TABLE</p>
                        </div>                        
                    </div>
                </div>
            </div>
