<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRF_MT_ICTrays.aspx.cs" Inherits="REPI_PUR_SOFRA.SRF_MT_ICTrays" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">PULL OUT OF IC TRAYS MAINTENANCE TABLE</p>
                        </div>                        
                    </div>
                </div>
            </div>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="BOX TYPE" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" > 
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtBoxType" runat="server" Text='<%# Eval("BoxType") %>' Width="100px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />                                   
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewBoxType" runat="server" Width="100px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>                                                                         
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="SIZE" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" > 
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtSize" runat="server" Text='<%# Eval("Size") %>' Width="100px" Height="14px" BorderStyle="Solid" BorderWidth="1px" />                                   
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtNewSize" runat="server" Width="100px" Height="16px" Font-Size="11px" BorderStyle="Solid" BorderWidth="1px" />
                                        </FooterTemplate>                                                                         
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
