<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DRF_ManualResponse.aspx.cs" Inherits="REPI_PUR_SOFRA.DRF_ManualResponse" MasterPageFile="~/Sofra.Master" %>
                    ...
                    <div class="card"> 
                        <div class="header" style="height:155px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">
                                DRF MANUAL UPLOAD FOR (<%= drf_number.ToString()%>)
                            </p>
                            <p style="color:Red; font-size:12px; font-weight:bold;">*** Make sure that you select valid csv file. It must be correct DRF Number</p>
                            ...
                            <p style="color:Red; font-size:12px; font-weight:bold;">*** You can also manual upload the excel(xlsx) attachment if there is any by clicking browse XLSX (EXCEL) FILE</p>
                            <p style="color:Red; font-size:12px; font-weight:bold;">*** PLEASE NOTE THAT YOU WILL NEED TO UPLOAD ALL FILES AT THE SAME TIME.</p>
                        </div>                        
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1280px;">
                    <div class="card">
                        <div class="body" style="margin-top:-23px; height:80px; width:1280px;">
                            XLSX (EXCEL) FILE
                            <asp:FileUpload ID="fuManualUploadExcel" runat="server" Font-Size="Large" Width="300px" EnableViewState="true" accept=".xlsx"  />
