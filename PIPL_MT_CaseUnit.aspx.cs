...
{
    public partial class PIPL_MT_CaseUnit : System.Web.UI.Page
    {
        ...
        private void LoadDefault()
        {
            try
            {
                ...
                list = BLL.PIPL_MT_CaseUnit_GetAll();
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_PIPL_CaseUnit entity = new Entities_PIPL_CaseUnit();
                        entity.RefId = lblId.Text.Trim();
                        entity.IsDisabled = "0";

                        BLL.PIPL_MT_CaseUnit_IsDisabled(entity);
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.PIPL_MT_CaseUnit_Append(entity);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Entities_PIPL_CaseUnit> list = new List<Entities_PIPL_CaseUnit>();
                list = BLL.PIPL_MT_CaseUnit_GetByName_Like(txtSearch.Text);
