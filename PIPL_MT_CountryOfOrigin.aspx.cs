...
{
    public partial class PIPL_MT_CountryOfOrigin : System.Web.UI.Page
    {
        ...
        private void LoadDefault()
        {
            try
            {
                ...
                list = BLL.PIPL_MT_CountryOfOrigin_GetAll();
        ...
        protected void gvDisabled_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "StartEnabling_Command")
                {
                    try
                    {
                        Entities_PIPL_CountryOfOrigin entity = new Entities_PIPL_CountryOfOrigin();
                        entity.RefId = lblId.Text.Trim();
                        entity.IsDisabled = "0";

                        BLL.PIPL_MT_CountryOfOrigin_IsDisabled(entity);
                ...
                if (e.CommandName == "StartUpdating_Command")
                {
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BLL.PIPL_MT_CountryOfOrigin_Append(entity);
                ...
                if (e.CommandName == "SaveNew_Command")
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            else if (BLL.PIPL_MT_CountryOfOrigin_GetByName(entity.Name).Count > 0)
                            {
                                ScriptManager.RegisterStartupScript(this, GetType(), "Popup", "ErrorMessage('" + entity.Name + " is already exist.');", true);
                            }
                            else
                            {
                                BLL.PIPL_MT_CountryOfOrigin_Insert(entity);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                List<Entities_PIPL_CountryOfOrigin> list = new List<Entities_PIPL_CountryOfOrigin>();
                list = BLL.PIPL_MT_CountryOfOrigin_GetByName_Like(txtSearch.Text);
