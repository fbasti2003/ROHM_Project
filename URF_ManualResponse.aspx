<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="URF_ManualResponse.aspx.cs" Inherits="REPI_PUR_SOFRA.URF_ManualResponse" MasterPageFile="~/Sofra.Master" %>
                    ...
                    <div class="card"> 
                        <div class="header" style="height:125px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">
                                URF MANUAL UPLOAD FOR (<%= urf_number.ToString()%>)
                            </p>
