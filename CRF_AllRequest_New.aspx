<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRF_AllRequest_New.aspx.cs" Inherits="REPI_PUR_SOFRA.CRF_AllRequest_New" MasterPageFile="~/Sofra.Master"%>
                            ...
                            <asp:GridView ID="gvData" runat="server" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="CTRLNO" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:LinkButton ID="linkCtrlNo" runat="server" Text='<%# Eval("RdCtrlNo") %>' Width="160px" CommandName="linkCtrlNo_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                            <asp:Label ID="lblCtrlNo" runat="server" Text='<%# Eval("RdCtrlNo") %>' Width="160px" Visible="false" />
                                        </ItemTemplate>    
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="DESCRIPTION" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblDescription" runat="server" Text='<%# Eval("RdItemName") %>' Width="190px" />
                                        </ItemTemplate>    
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="SPECIFICATION" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblPrNo" runat="server" Text='<%# Eval("RdSpecs") %>' Width="190px" />
                                        </ItemTemplate>    
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
