<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="URF_ApprovalForm_New2.aspx.cs" Inherits="REPI_PUR_SOFRA.URF_ApprovalForm_New2" MasterPageFile="~/Sofra.Master" %>
                                                    ...
                                                    <asp:GridView ID="gvDataStatus" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                                         ...
                                                         <Columns>
                                                            <asp:TemplateField HeaderText="SEC. MANAGER" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProdSecManager" runat="server" Text='<%# Eval("StatProdSecManager") %>' Width="220px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                         </Columns> 
                                                         ...
                                                         <Columns>
                                                            <asp:TemplateField HeaderText="PROD. DEPT. MANAGER" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProdDeptManager" runat="server" Text='<%# Eval("StatProdDeptManager") %>' Width="220px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                         </Columns>
                                                         ...
                                                         <Columns>
                                                            <asp:TemplateField HeaderText="PROD. DIV. MANAGER" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProdDivManager" runat="server" Text='<%# Eval("StatProdDivManager") %>' Width="220px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                         </Columns>
                                                         ...
                                                         <Columns>
                                                            <asp:TemplateField HeaderText="PUR. BUYER" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblPurchasingBuyer" runat="server" Text='<%# Eval("StatPurchasingBuyer") %>' Width="220px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                         </Columns>
                                                         ...
                                                         <Columns>
                                                            <asp:TemplateField HeaderText="PUR. MANAGER" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblPurchasingManager" runat="server" Text='<%# Eval("StatPurchasingManager") %>' Width="220px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                         </Columns>
