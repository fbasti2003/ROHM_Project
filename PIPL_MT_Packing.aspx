<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PIPL_MT_Packing.aspx.cs" Inherits="REPI_PUR_SOFRA.PIPL_MT_Packing" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">PACKING</p>
                        </div>                        
                    </div>
                </div>
            </div>
