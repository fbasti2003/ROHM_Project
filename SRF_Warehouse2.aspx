<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRF_Warehouse2.aspx.cs" Inherits="REPI_PUR_SOFRA.SRF_Warehouse2" MasterPageFile="~/Sofra.Master" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
        ...
        function SuccessMessageForCurrentDelivery(msg) {
            swal({
                title: "SUCCESS",
                text: msg,
                type: "success"
    ...
    <ContentTemplate>
        ...
        <div class="container-fluid" style="margin-top:-50px; margin-left:-320px; width:1800px;">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1800px;">
                    <div class="card"> 
                        <div class="body" style="margin-top:-23px; height:100px; width:1800px;">
                            <div style="margin-top:10px;">
                                <table style="width:1750px; color:Gray; font-size:12px;">
                                  <tr>
                                    <th>FROM (PULLOUT DATE)</th>
                                    <th>TO (PULLOUT DATE)</th>
                                    <th>ENTER ITEM YOU WANT TO SEARCH</th>
                                    <th>STATUS</th>
                                    <th>DELIVERED/CLOSED</th>
                                    <th>SEARCH</th>
                                    <th>LOAD ITEMS WITH NO LOA8106</th>
                                    <th>DOWNLOAD</th>
                                  </tr>
                                  <tr>
                                    <td><asp:TextBox ID="txtFrom2" runat="server" Width="190px" Height="28px" Font-Bold="true" Font-Size="14px" class="form-control" /></td>
                                    <td><asp:TextBox ID="txtTo2" runat="server" Width="190px" Height="28px" Font-Bold="true" Font-Size="14px" class="form-control" /></td>  
                                    <td><asp:TextBox ID="txtSearch" runat="server" Width="250px" Height="28px" Font-Bold="true" Font-Size="14px" class="form-control" onkeydown='searchWithKeyPress(this)' /></td>
                                    <td>
                                        <asp:DropDownList ID="ddStatus" runat="server" Width="250px" Height="28px" class="form-control">
                                    ...
                                    <td>
                                        <asp:Button ID="btnLoad8106" runat="server" Text="LOAD ITEMS WITH NO LOA8106" Height="28px" CssClass="btn bg-pink waves-effect" OnClick="btnLoad8106_Click" />
                                    </td>  
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1800px;">
                    <div class="card"> 
                        <div class="header" style="height:60px; margin-top:-23px;">
                        
                        <table style="width:400px; color:Gray; font-size:12px;">
                            <tr>
                                <th>TOTAL PULLOUT QUANTITY</th>
                                <th>TOTAL UNIQUE CONTROL NUMBER</th>
                            </tr>
                            <tr>
                                <td><asp:Label ID="lblOverallTotalQuantity" runat="server" ForeColor="Black" /></td>
                                <td><asp:Label ID="lblTotalUnique8106" runat="server" ForeColor="Black" /></td>
                            </tr>
                        </table>
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="ITM" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="lblItm" runat="server" Text='<%# Eval("Old8106") %>' Height="15px" Width="30px" Font-Size="11px" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="REQUESTER" HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblRequester" runat="server" Width="200px" Text='<%# Eval("Warehouse_RequesterName") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="SUPPLIER" HeaderStyle-Width="200px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblSupplier" runat="server" Width="200px" Text='<%# Eval("Warehouse_SupplierName") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="PULLOUT DATE" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblPullOutDate" runat="server" Width="100px" Text='<%# Eval("Warehouse_PullOutServiceDate") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="STATUS" HeaderStyle-Width="190px" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Middle" >
                                        <ItemTemplate>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="ACTION" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" >
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbPrint" runat="server" Text="VIEW" CommandName="lbPrint_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />  <br />
                                            <asp:LinkButton ID="lbQuantityCorrections" runat="server" Text="QTY. CORRECTIONS" Visible="false" CommandName="lbQuantityCorrections_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />                                          
                                            <asp:Label ID="lblLOACount2" runat="server" Visible="false" Text='<%# Eval("Warehouse_LoaCount2") %>'  />  
                                        </ItemTemplate>                                                                        
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="PENDING DOCS?" HeaderStyle-Width="115px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" >
                                        <ItemTemplate>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1200px;">
                            <div class="card">
                                ...
                                <asp:GridView ID="gvDetails" runat="server" Visible="false"
                                                          AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px" RowStyle-Height="22px" OnRowCommand="gvDetails_RowCommand"
                                            ...
                                            <asp:TemplateField HeaderText="REFID" ItemStyle-CssClass="columnSpace">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblInProgress" runat="server" Visible="false" Text='<%# Eval("InProgress") %>' ></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="ACTION" ItemStyle-CssClass="columnSpace" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="168px">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lbAddFromCurrentDelivery" runat="server" Width="168px" Visible="false" Text="ADD TO CURRENT DELIVERY" CommandName="lbAddFromCurrentDelivery_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                </ItemTemplate>
                                            </asp:TemplateField> 
                                            ...
                                            <ItemTemplate>
                                                <tr style="height:40px;">
                                                    <td colspan="13" style="background-color:White;">
                                                        <p style="font-size:12px; font-weight:bold;">REMARKS : 
                                                            <asp:TextBox ID="txtBuyerNotes" runat="server" Width="800px" Height="20px" Font-Size="12px" Text='<%# Eval("RemarksFromWarehouse") %>' />                                                                                                                          
                                                        </p>                                                        
                                                    </td>                                                    
                                                </tr>
                                            </ItemTemplate>
                                    ...
                                    <div id="divCorrectionRequired" runat="server" style="display:none;">
                                        <p style="color:Red; font-size:12px;">!!! NEW QTY. AND REASON OF CORRECTION ARE REQUIRED FIELD !!!</p>
                                    </div>
                                    
                                    <asp:GridView ID="gvDetailsQuantityCorrections" runat="server" Visible="false"
                                            ...
                                            <asp:TemplateField HeaderText="NEW QTY." ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtQuantityCorrection" runat="server" Width="80px"  />
                                                </ItemTemplate>                    
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="REASON OF CORRECTION" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtReasonOfCorrection" runat="server" Width="200px" />
                                                </ItemTemplate>                    
                                            </asp:TemplateField>
                                            
                                            <asp:TemplateField HeaderText="ACTION" ItemStyle-CssClass="columnSpace" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="120px">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnCorrection" runat="server" Text="UPDATE QUANTITY" CommandName="btnCorrection_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                </ItemTemplate>
                                            </asp:TemplateField> 
                                        </Columns>
                                    ...
                                    <div style="margin-top:10px; width:600px;">
                                        ...
                                        <asp:Button ID="btnClose3" runat="server" Width="100px" Text="CLOSE" CssClass="btn btn-block bg-pink waves-effect" OnClientClick="hideDialog();" />
                                    </div>                                                                               
                            ...
                            <div class="card">
                                <div class="body" style="margin-top:-23px; min-height:20px; width:1060px;">
                                    <table style="width:100%; margin-top:10px; color:Gray;">
                                      ...
                                      <tr>
                                        <p id="Reminder1" runat="server" style="color:Red; font-size:14px; font-weight:bold;">!!! REMINDER !!!</p>
                                        <p id="Reminder2" runat="server" style="color:Red; font-size:12px;">
                                            This is a one-time attachment just incase you are receiving the same document for all items and you don't have to select HAS ATTACHMENT? field because it will automatically set to YES. If you are receiving different documents for every items then you should add
                                            the attachment by clicking Choose File after the HAS DOCUMENT? field.
                                        </p>
                                      </tr>
                                    </table>
                                    <hr />
                                    ...
                                    <table style="width:100%; margin-top:10px; color:Gray; text-align:left;">
                                        ...
                                        <tr>
                                            ...
                                            <div class="WordWrap">
                                            <asp:GridView ID="gvActualDelivery" runat="server" OnRowDataBound="gvActualDelivery_OnRowDataBound" ShowHeader="false" OnRowCommand="gvActualDelivery_RowCommand"
                                                        ...
                                                        <Columns>                                   
                                                        <asp:TemplateField HeaderText="REFID" ItemStyle-CssClass="columnSpace" ControlStyle-BackColor="#E91E63">
                                                            <ItemTemplate>
                                                                <div style="text-align:left; background-color:#00BCD4; color:White; font-weight:bold;">
                                                                    REFID
                                                                </div>
                                                                <asp:Label ID="lblRefId" runat="server" Width="40px" Text='<%# Eval("RefId") %>' ForeColor="White" Font-Bold="true" ></asp:Label>
                                                                <asp:Label ID="lblInProgressRefId" runat="server" Visible="false" Text='<%# Eval("InProgressRefId") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="REF PR/PO" ItemStyle-CssClass="columnSpace" ControlStyle-BackColor="#dddddd">
                                                            <ItemTemplate>
                                                                <div style="text-align:left; background-color:#00BCD4; color:White; font-weight:bold;">
                                                                    REF PR/PO
                                                                </div>
                                                        ...
                                                        <asp:TemplateField HeaderText="SALES INVOICE" ItemStyle-CssClass="columnSpace" ControlStyle-BackColor="#dddddd">
                                                            <ItemTemplate>
                                                                <div style="text-align:left; background-color:#00BCD4; color:White; font-weight:bold;">
                                                                    SALES INVOICE
                                                                </div>
                                                        ...
                                                        <asp:TemplateField HeaderText="BRAND / MACHINE" ItemStyle-CssClass="columnSpace" ControlStyle-BackColor="#dddddd">
                                                            <ItemTemplate>
                                                                <div style="text-align:left; background-color:#00BCD4; color:White; font-weight:bold;">
                                                                    BRAND / MACHINE
                                                                </div>
                                                        ...
                                                        <asp:TemplateField HeaderText="ITEM NAME" ItemStyle-CssClass="columnSpace" ControlStyle-BackColor="#dddddd">
                                                            <ItemTemplate>
                                                                <div style="text-align:left; background-color:#00BCD4; color:White; font-weight:bold;">
                                                                    ITEM NAME
                                                                </div>
                                                        ...
                                                        <asp:TemplateField HeaderText="SPECIFICATION" ItemStyle-CssClass="columnSpace" ControlStyle-BackColor="#dddddd">
                                                            <ItemTemplate>
                                                                <div style="text-align:left; background-color:#00BCD4; color:White; font-weight:bold;">
                                                                    SPECIFICATION
                                                                </div>
                                                        ...
                                                        <asp:TemplateField HeaderText="QTY" ItemStyle-HorizontalAlign="Center" ControlStyle-BackColor="#dddddd">
                                                            <ItemTemplate>
                                                                <div style="text-align:left; background-color:#00BCD4; color:White; font-weight:bold;">
                                                                    QTY
                                                                </div>
                                                        ...
                                                        <asp:TemplateField HeaderText="UOM" ItemStyle-HorizontalAlign="Center" ControlStyle-BackColor="#dddddd">
                                                            <ItemTemplate>
                                                                <div style="text-align:left; background-color:#00BCD4; color:White; font-weight:bold;">
                                                                    UOM
                                                                </div>
                                                        ...
                                                        <asp:TemplateField HeaderText="SERIAL NO" ItemStyle-CssClass="columnSpace" ControlStyle-BackColor="#dddddd">
                                                            <ItemTemplate>
                                                                <div style="text-align:left; background-color:#00BCD4; color:White; font-weight:bold;">
                                                                    SERIAL NO
                                                                </div>
                                                        ...
                                                        <asp:TemplateField HeaderText="DEL. QTY." ItemStyle-CssClass="columnSpace" ItemStyle-HorizontalAlign="Center" ControlStyle-BackColor="#dddddd">
                                                            <ItemTemplate>
                                                                <div style="text-align:left; background-color:#00BCD4; color:White; font-weight:bold;">
                                                                    DEL. QTY.
                                                                </div>
                                                                <asp:Label ID="txtActualQty" runat="server" Width="80px" Text='<%# Eval("Warehouse_TotalActualQuantity") %>'/>
                                                            </ItemTemplate>
                                                        </asp:TemplateField> 
                                                        <asp:TemplateField HeaderText="REM. QTY." ItemStyle-CssClass="columnSpace" ItemStyle-HorizontalAlign="Center" ControlStyle-BackColor="#dddddd">
                                                            <ItemTemplate>
                                                                <div style="text-align:left; background-color:#00BCD4; color:White; font-weight:bold;">
                                                                    REM. QTY.
                                                                </div>
                                                                <asp:Label ID="txtRemainingQty" runat="server" Width="80px" Text='<%# Eval("Warehouse_RemainingQuantity") %>'/>
                                                            </ItemTemplate>
                                                        </asp:TemplateField> 
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                ...
                                                                <tr>
                                                                    <td colspan="100%" style="background-color:White; margin-top:30px;">
                                                                        <div style="margin-left:7px;">
                                                                            HISTORY OF DELIVERED ITEMS
                                                                        </div>
                                                                        <div style="margin-left:7px;">
                                                                            <asp:GridView ID="gvActualPrevious" runat="server" OnRowDataBound="gvActualPrevious_OnRowDataBound" OnRowCommand="gvActualPrevious_RowCommand"
                                                                                  AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px" RowStyle-Height="22px"
                                                                                  HeaderStyle-Font-Bold="false" AlternatingRowStyle-BackColor="#dddddd" EmptyDataText="NO DELIVERED ITEMS YET"
                                                                                  HeaderStyle-BackColor="Black" HeaderStyle-ForeColor="White" FooterStyle-Font-Size="10px">
                                                                                  ...
                                                                                  <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="ITEM NAME" ItemStyle-Width="350px" ItemStyle-HorizontalAlign="Left">
                                                                                            <ItemTemplate>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="ATTACHMENT" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Left">
                                                                                            <ItemTemplate>
                                                                                                <asp:LinkButton ID="lbAttachment" runat="server" Visible="true" Text='<%# Eval("Warehouse_AttachmentWarehouse") %>' CommandName="lbAttachment_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                   </Columns>
                                                                        ...
                                                                        <table id="tblActualEntry" runat="server" style="width:80%; text-align:left; margin-left:7px;">
                                                                            <tr>
                                                                                <th style="font-weight:normal;">ACTUAL QUANTITY</th>
                                                                                <th style="font-weight:normal;">HAS DOCUMENT?</th>
                                                                                <th style="font-weight:normal;">ATTACHMENT</th>
                                                                                <th style="font-weight:normal;">REMOVE FROM CURRENT DELIVERY</th>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:TextBox ID="txtActualQuantity2" runat="server" Width="150px" Height="22px" onkeypress="return isNumberKey(event)" />
                                                                                </td>
                                                                                <td>
                                                                                    <asp:DropDownList ID="ddWithDocuments" runat="server" Width="150px" Height="22px" >
                                                                                        <asp:ListItem Text="" Value="" />
                                                                                ...
                                                                                <td>
                                                                                    <asp:FileUpload ID="fuAttachment" runat="server" Width="190px" EnableViewState="true" accept=".pdf" />
                                                                                </td>
                                                                                <td>
                                                                                    <asp:Button ID="btnRemoveFromCurrentDelivery" runat="server" Width="100px" Text="REMOVE" CssClass="btn btn-block bg-indigo waves-effect" CommandName="btnRemoveFromCurrentDelivery_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                    ...
                                    <div style="width:1050px; text-align:center;">
                                        <table style="width:100%; margin-top:10px; color:Gray; text-align:center;">
                                          <tr>                                                                                                                                                    
                                            <td>
                                            ...
                                            <td>
                                                <asp:Button ID="btnRevert" runat="server" Text="REVERT TO APPROVED/WAITING FOR DELIVERY" Visible="false" CssClass="btn bg-blue-grey waves-effect" OnClick="btnRevert_Click" />
                                            </td>
                                            <td>
                ...
                <div>
                    <table style="width:100%; margin-top:10px; color:Gray; text-align:left;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnDownloadReport2" runat="server" Text="DOWNLOAD DETAIL REPORT" CssClass="btn bg-light-green waves-effect" OnClick="btnDownloadReport2_Click" />
                                <asp:Button ID="btnDownloadReport3" runat="server" Text="DOWNLOAD SUMMARY REPORT" CssClass="btn bg-blue-grey waves-effect" OnClick="btnDownloadReport3_Click" />&nbsp;
                            </td>
                            <td>
            ...
            <asp:HiddenField ID="ctrlnoList" runat="server" />           
