<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="REPORTING_DRF.aspx.cs" Inherits="REPI_PUR_SOFRA.REPORTING_DRF" MasterPageFile="~/Sofra.Master" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width:1280px;">
                    <div class="card"> 
                        <div class="header" style="height:30px;">
                            <p style="color:Gray; font-size:14px; font-weight:bold;">DRF APPROVAL/DISAPPROVAL COUNTS</p>
                        </div>                        
                    </div>
                </div>
            </div>
                    ...
                    <div class="card"> 
                        <div class="body" style="margin-top:-23px; min-height:200px; width:1280px;">
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="POSTED/CLOSED" HeaderStyle-Width="130px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                            ...
                            <asp:GridView ID="gvDataAll" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="POSTED/CLOSED" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="TOTAL POSTED/APPROVED" HeaderStyle-Width="160px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                            ...
                            <asp:GridView ID="gvDataDetails" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="PRNO" HeaderStyle-Width="210px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblPRNO" runat="server" Height="15px" Width="210px" Text='<%# Eval("PrNO") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="PONO" HeaderStyle-Width="130px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblPONO" runat="server" Height="15px" Width="130px" Text='<%# Eval("PoNO") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="INVOICE DR/NO" HeaderStyle-Width="130px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblInvoiceDRNO" runat="server" Height="15px" Width="130px" Text='<%# Eval("InvoiceDRNO") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="TYPE DRAWING/NO" HeaderStyle-Width="210px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblTypeDrawing" runat="server" Height="15px" Width="210px" Text='<%# Eval("TypeDrawingNo") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>                                                                
                                <Columns>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="STATUS" HeaderStyle-Width="130px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            <asp:Label ID="lblStatus" runat="server" Height="15px" Width="130px" Text='<%# Eval("StatAll") %>'  />                                            
                                        </ItemTemplate> 
                                    </asp:TemplateField>
                                </Columns>
