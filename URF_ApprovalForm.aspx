<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="URF_ApprovalForm.aspx.cs" Inherits="REPI_PUR_SOFRA.URF_ApprovalForm" MasterPageFile="~/Sofra.Master" %>
                            ...
                            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px" Visible="false"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="NO" HeaderStyle-Width="30px" ItemStyle-HorizontalAlign="Left" > 
                                        <ItemTemplate>
                                            <asp:Label ID="lblCounter" runat="server" Text='<%# ((GridViewRow) Container).RowIndex + 1%>' Height="80px" Width="28px" Font-Size="11px" />                                              
                                        </ItemTemplate>                                
                                    </asp:TemplateField>
                                </Columns>
                                <Columns>
                                    <asp:TemplateField HeaderText="CTRLNO" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Left" >
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="lbCTRLNo" runat="server" Height="15px" Text='<%# Eval("RhCTRLNo") %>' CommandName="lbCTRLNo_Command" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Font-Bold="true" />  
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="STATUS" HeaderStyle-Width="170px" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Middle" > 
                                        <ItemTemplate>
                                            <asp:Label ID="lblStatAll" runat="server" Text='<%# Eval("StatAll") %>' Height="80px" Width="168px" Font-Size="11px" ForeColor="White" /> 
                                                    ...
                                                    <asp:GridView ID="gvDataDetails" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="ITEM NAME" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblItemName" runat="server" Text='<%# Eval("RdItemName") %>' Width="220px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="SPECIFICATION" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSpecification" runat="server" Text='<%# Eval("RdSpecs") %>' Width="220px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="QTY." ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("RdQuantity") %>' Width="40px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>                                                        
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="P.O. DATE" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDeliveryConfirmationDate" runat="server" Text='<%# Eval("RdDeliveryConfirmationDate") %>' Width="125px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>     
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="REQ. DEL. DATE" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRequestedDeliveryDate" runat="server" Text='<%# Eval("RdRequestedDeliveryDate") %>' Width="125px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="REP. DEL. DATE" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblReplyDeliveryDate" runat="server" Text='<%# Eval("RdReplyDeliveryDate") %>' Width="125px" Height="30px" Font-Size="11px" />                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>                                                                                                                                                                                                                                                                                                                                                                                                                         
                                                    ...
                                                    <asp:GridView ID="gvDataStatus" runat="server" AutoGenerateColumns="false" RowStyle-Font-Size="11px" HeaderStyle-Font-Size="11px"
                                                         ...
                                                         <Columns>
                                                            <asp:TemplateField HeaderText="SEC. MANAGER" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProdSecManager" runat="server" Text='<%# Eval("StatProdSecManager") %>' Width="195px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                         </Columns> 
                                                         ...
                                                         <Columns>
                                                            <asp:TemplateField HeaderText="PROD. DEPT. MANAGER" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProdDeptManager" runat="server" Text='<%# Eval("StatProdDeptManager") %>' Width="195px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                         </Columns>
                                                         ...
                                                         <Columns>
                                                            <asp:TemplateField HeaderText="PROD. DIV. MANAGER" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProdDivManager" runat="server" Text='<%# Eval("StatProdDivManager") %>' Width="195px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                         </Columns>
                                                         ...
                                                         <Columns>
                                                            <asp:TemplateField HeaderText="PROD. HQ. MANAGER" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProdHQManager" runat="server" Text='<%# Eval("StatProdHQManager") %>' Width="195px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                         </Columns>
                                                         ...
                                                         <Columns>
                                                            <asp:TemplateField HeaderText="PUR. BUYER" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblPurchasingBuyer" runat="server" Text='<%# Eval("StatPurchasingBuyer") %>' Width="195px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                         </Columns>
                                                         ...
                                                         <Columns>
                                                            <asp:TemplateField HeaderText="PUR. MANAGER" ItemStyle-HorizontalAlign="Left">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblPurchasingManager" runat="server" Text='<%# Eval("StatPurchasingManager") %>' Width="195px" Height="30px" Font-Size="11px"/>                                                                                                                                            
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                         </Columns>
